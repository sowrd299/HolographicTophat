...
class PlayerUIButton extends CompositButton{
    ...
    PlayerUIButton(PlayerUI opponent, Rect rect, color c, ButtonHandler handler, int stroke_weight, int corner_size){
        ...
        //inactive_button = new BackgroundButton(rect.get_section(0.05,0.45,0.9,0.3), opponent.get_id() + " (Inactive)", c, null, int(r.get_h()*0.15), stroke_weight, corner_size, corner_size/2);
